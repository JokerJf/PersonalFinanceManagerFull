...
export const AppDataSource = new DataSource({
  ...
  // ВАЖНО: synchronize: true опасен в продакшне — может изменить/удалить колонки.
  // В продакшне используй только миграции: npm run migration:run
  synchronize: !isProduction,
  logging: process.env.DB_LOGGING === 'true',

  entities: [
    User, Account, Transaction, Debt, Credit, ExchangeRate,
    Notification, BudgetPlan, BudgetCategoryLimit, BudgetIncomePlanItem,
    FamilyRequest, FamilyGroup, Session,
  ],
